  const API_KEY = '6dd144367162ab13fb56cac4972ea682';
        ...
        async function fetchWeatherByCity(city) {
            ...
            try {
                ...
                showError(error.message || 'City not found. Please try another city.');
        ...
        function updateWeatherDisplay(data) {
            ...
            document.getElementById('windDirection').textContent = `${getWindDirection(data.wind.deg)} Direction`;
            ...
            for (let i = 0; i < hourlyData.length; i += 2) {
                ...
                for (let j = i; j < Math.min(i + 2, hourlyData.length); j++) {
                    ...
                    hourDiv.innerHTML = `
                        ...
                        <div class="forecast-icon">${weatherIcons[hour.weather[0].icon] || '🌡️'}</div>
